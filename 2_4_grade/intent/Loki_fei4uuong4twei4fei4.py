...
if CHATBOT_MODE:
    try:
        responseDICT = json.load(open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "reply/reply_fei4uuong4twei4fei4.json"), encoding="utf-8"))
    except Exception as e:
