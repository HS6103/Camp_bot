...
if CHATBOT_MODE:
    try:
        responseDICT = json.load(open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "reply/reply_gwo4ye4.json"), encoding="utf-8"))
    except Exception as e:
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT):
    ...
    if utterance == "過夜營隊[晚上]所居住的[地點]是什麼":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "過夜營隊[晚上]的住宿[地點][會]是在哪裡":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "過夜營隊的住宿[地點][該]如何前往":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
