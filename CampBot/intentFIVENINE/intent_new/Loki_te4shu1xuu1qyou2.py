...
if CHATBOT_MODE:
    try:
        responseDICT = json.load(open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "reply/reply_te4shu1xuu1qyou2.json"), encoding="utf-8"))
    except Exception as e:
