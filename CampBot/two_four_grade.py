...
def testIntent():
    ...
    inputLIST = ['推薦營隊','參加什麼營','想了解營隊','有哪些營隊','參加哪個營隊','有適合的營隊','適合什麼營隊','推薦適合的營隊','報名參加哪個營隊','有什麼營隊可參加','有哪些營隊能夠報名','有哪幾個營隊可以參加','有多少種營隊可以選擇','可以參加的營隊有哪些？','有哪些營隊是可以報名的']
